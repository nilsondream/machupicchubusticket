...
const PricingSection = () => {
  ...
  return (
    <section className="py-16 max-md:py-12 border-t" id="pricing">
      <div className="space-y-8 max-md:px-0">
        ...
        <div className="grid md:grid-cols-3 gap-6">
          <div className="bg-card border rounded-3xl p-8 space-y-10">
            ...
            <div className="grid grid-cols-2 gap-6">
              <div>
                ...
                <p className="text-5xl font-bold tracking-tighter">${currentPrices.roundTrip.adult}</p>
              </div>
              <div>
                <p className="text-sm text-muted-foreground mb-1">Child</p>
                <p className="text-5xl font-bold tracking-tighter text-muted-foreground">${currentPrices.roundTrip.child}</p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-card border rounded-3xl p-8 flex flex-col">
            ...
            <div className="mt-auto space-y-6">
              <div>
                <p className="text-sm text-muted-foreground mb-1">Adult</p>
                <p className="text-5xl font-bold tracking-tighter">${currentPrices.upward.adult}</p>
              </div>
              <div>
                <p className="text-sm text-muted-foreground mb-1">Child</p>
                <p className="text-4xl font-bold tracking-tighter text-muted-foreground">${currentPrices.upward.child}</p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-card border rounded-3xl p-8 flex flex-col">
            ...
            <div className="mt-auto space-y-6">
              <div>
                <p className="text-sm text-muted-foreground mb-1">Adult</p>
                <p className="text-5xl font-bold tracking-tighter">${currentPrices.downward.adult}</p>
              </div>
              <div>
                <p className="text-sm text-muted-foreground mb-1">Child</p>
                <p className="text-4xl font-bold tracking-tighter text-muted-foreground">${currentPrices.downward.child}</p>
              </div>
            </div>
          </div>
        </div>
